...
!function ($, moment) {
	document.write("<script type='text/javascript' src='../../common/angular/angular-1.3.2.min.js'></script>"); 
    ...
    DateRangePicker.prototype = {
        ...
        clickApply: function (e) {
            ...
            $("#yts").click();
//          console.log()
//          var appElement = document.querySelector('[ng-controller=publicEditCtrl]');
